document.addEventListener('DOMContentLoaded', function() {
        ...
        fetch('notificaciones.php')
            ...
            .then(data => {
                ...
                data.forEach(notificacion => {
                    ...
                    // Mostrar la notificación con una pequeña animación de desvanecimiento
                    setTimeout(() => {
            ...
            if (data.length > 0) {
                ...
                resultados.innerHTML = `
                    ...
                    <div>
                        ...
                        <p>Precio por Noche: $${hotel.precio_por_noche}</p>
    ...
    // Obtener y mostrar notificaciones al cargar la página
